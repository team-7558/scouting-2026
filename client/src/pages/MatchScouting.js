...
function MatchScouting() {
  ...
  function onScreenClicked(e) {
    ...
    if (!buttonClicked && !(hasAlgae && hasCoral)) {
      ...
      setCurrentIntake([
        (clickX - 0.3 * width) / (width - 0.3 * width),
        clickY / (window.innerHeight - 30),
      ]);
  ...
  function drawCanvas(canvasRef) {
    ...
    function drawAuto() {
      ...
      if (sideMenuButtons == sideMenuOptions.nothing) {
        ...
        //L1-4, drop, descore algae, cancel. TODO: implement descore algae button
        //descore algae
